                   ...
                   delegate:(NSObject <SlidingTabsControlDelegate>*)slidingTabsControlDelegate 
{
    if ((self = [super init]))
    {
        ...
        CGFloat buttonWidth = 107.0f;//(320.0 / tabCount);

        // Set our frame
        //self.frame = CGRectMake(0, 20, 320, 40);
        self.frame = CGRectMake(0, 20, buttonWidth * tabCount, 40);
        ...
        // Draw our tab!
        _tab = [[SlidingTabsTab alloc] initWithFrame:CGRectMake(-5, 1, buttonWidth+10.0, buttonHeight)];
...
- (void)drawRect:(CGRect)rect
{
    ...
    CGFloat components[8] = { 180.0/255.0f, 180.0/255.0f, 180.0/255.0f, 1.0,  // Start color
                              140.0/255.0f, 140.0/255.0f, 140.0/255.0f, 1.0 }; // End color
...
- (void)touchUpInsideAction:(UIButton*)button
{
    ...
    [_tab setFrame:CGRectMake(newPosition, 1, _tab.frame.size.width, _tab.frame.size.height)];
...
- (void) moveToIndex:(NSNumber *)index {
    //CGFloat segmentCount = [_buttons count];
    //CGFloat buttonWidth = (320.0 / segmentCount);
    CGFloat buttonWidth = 107.0f;//(320.0 / tabCount);
    CGFloat buttonIndex = [index floatValue];
    CGFloat newPosition = (buttonWidth * buttonIndex) - 5.0;
    ...
    if ([_delegate respondsToSelector:@selector(touchUpInsideTabIndex:)])
        [_delegate touchUpInsideTabIndex:[index integerValue]];
}
