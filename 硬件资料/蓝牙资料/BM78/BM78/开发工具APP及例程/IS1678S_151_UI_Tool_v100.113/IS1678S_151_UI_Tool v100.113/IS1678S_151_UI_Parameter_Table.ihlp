...
Pairty Check
Set this parameter to enable configure UART module for pairty setting;;help_end;;
IDC_STATIC_PARITY_CHECK
Stop Bits
This Parameter is used to configure UART module for pairty setting;;help_end;;
IDC_STATIC_STOP_BITS
Parity Mode
This Parameter is used to configure UART module for pairty setting;;help_end;;
IDC_STATIC_PARITY_MODE
...
Sniff Interval
RF Off interval under connected state, if want to save more power, this function be enabled is necessary. The recommended value is 0x0320.  ;;help_end;;
...
Bluetooth 3.0 Pairing Mode
Enable/Disable Bluetooth 3.0 Pairing Mode.;;help_end;;
...
This parameter is used to enable/disable LE user confirm passkey refer to PIN code. And PIN Code must set 6 digits if enable.;;help_end;;
...
0xff :enable function and never enter S2 mdoe.;;help_end;;
...
LDO33
This parameter is uesd to enable LDO33.;;help_end;;
IDC_STATIC_SWITCH_MODE
SW Button Feature
This parameter is used to enable/disable SW button.;;help_end;;
IDC_STATIC_SW_BUTTON_FEATURE
EEPROM Footprint
...
High Battery Level
High battery level(4.0V);;help_end;;
...
Dangerout battery level(2.0V);;help_end;;
...
When set this parameter to Enable, the accessory even no receiving a successful acknowledgment of an AccessoryDataTransfer command, the accessory may immediately send a new command containing available data for any session ID.;;help_end;;
IDC_STATIC_BURST_IAP_TRANSMISSION
Data Retransmission Interval
The interval of data retransmission;;help_end;;
IDC_STATIC_DATA_RETRANSMISSION_INTERVAL
Bundle Seed ID Pref Token
This string identifies the accessory's preferred application.;;help_end;;
IDC_STATIC_BONDLE_SEED_ID_PREF_TOKEN
SDK Protocol Token
This information is used to establish communication channels to the application.;;help_end;;
IDC_STATIC_SDK_PROTOCOL_TOKEN
APP Bundle ID
The accessory sends this command to an iPod to request that it launch a specific application.
The accessory passes an Application Bundle ID string, such as 'com.mycompany.myapp', to specify which application to launch.;;help_end;;
IDC_STATIC_APP_BUNDLE_ID
Accessory Name
Please refer to the \"MFi Accessory Firmware specification\".;;help_end;;
IDC_STATIC_ACCESSORY_NAME
Accessory Firmware Version
Please refer to the \"MFi Accessory Firmware specification\".;;help_end;;
IDC_STATIC_ACCESSORY_FIRMWARE_VERSION
Accessory Hardware Version
...
Please refer to the \"MFi Accessory Firmware specification\".;;help_end;;
IDC_STATIC_ACCESSORY_MANUFACTUER
Accessory Model Number
Please refer to the \"MFi Accessory Firmware specification\".;;help_end;;
IDC_STATIC_ACCESSORY_MODEL_NUMBER
Accessory Serial Number
Please refer to the \"MFi Accessory Firmware specification\".;;help_end;;
IDC_STATIC_ACCESSORY_SERIAL_NUMBER
Beacon Feature
